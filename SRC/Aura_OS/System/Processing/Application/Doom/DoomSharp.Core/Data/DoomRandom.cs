...
public static class DoomRandom
{
    private static readonly int[] RandomTable =
    {
    ...
    public static int P_Random()
    {
        ...
        return RandomTable[_pRandomIndex];
    }

    public static int M_Random()
    {
        _randomIndex = (_randomIndex + 1) & 0xFF;
        return RandomTable[_randomIndex];
    }

    public static void ClearRandom()
    {
        _randomIndex = _pRandomIndex = 0;
    }
}