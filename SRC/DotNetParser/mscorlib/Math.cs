...
namespace System
{
    public static partial class Math
    {
        ...
        {
            throw new Exception("ThrowNegateTwosCompOverflow");
        }
       ...
       // [CLSCompliant(false)]
        ...
        public static unsafe double Round(double value, int digits, MidpointRounding mode)
        {
            ...
            {
                throw new Exception("nameof(digits), SR.ArgumentOutOfRange_RoundingDigits");
            }

            if (mode < MidpointRounding.ToEven || mode > MidpointRounding.ToPositiveInfinity)
            {
                throw new Exception("SR.Format(SR.Argument_InvalidEnumValue, mode, nameof(MidpointRounding)");
            }
        ...
        public static int Sign(double value)
        {
            ...
            throw new Exception("ArithmeticException(SR.Arithmetic_NaN)");
        }
        ...
        public static int Sign(float value)
        {
            ...
            throw new Exception("Arithmetic_NaN");
        }
        ...
        {
            throw new Exception("ThrowMinMaxException");
        }
