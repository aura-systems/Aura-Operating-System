    ...
    class PingOld
    {
        ...
        public static void Send(Address address, string servername = null)
        {
            ...
            {   
                ...
                if(servername != null)
                {
                    Console.WriteLine("Sending PingOldOld to " + servername + " [" + destination.ToString() + "]");
                }
                else
                {
                    Console.WriteLine("Sending PingOld to " + destination.ToString());
                }
                ...
                for (int i = 0; i < 4; i++)
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            if (source == destination) //If we're PingOlding our interface => PingOld ok
                            {
                            ...
                            else if (destination.IsLoopbackAddress()) //Loopback address => PingOld ok
                            {
                                Console.WriteLine("Reply received from " + destination.ToString());
                                ICMPPacket.recvd_reply = null;
            ...
            finally
            {
                ...
                Console.WriteLine();
                Console.WriteLine("PingOld statistics for " + destination.ToString() + ":");
