...
namespace Aura_OS.System
{
    class NetworkInit
    {
        public static void Init()
        {
            ...
            Network.NetworkStack.ConfigIP(xNic, new Network.IPV4.Config(new Network.IPV4.Address(0,0,0,0), new Network.IPV4.Address(0,0,0, 0), new Network.IPV4.Address(0,0,0,0)));
