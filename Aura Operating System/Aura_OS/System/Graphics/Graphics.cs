...
namespace Aura_OS.System.Graphics
{
    public class Graphics
    {
        ...
        public Graphics()
        {
            ...
            frontpen = new Pen(Color.FromArgb((int)Pallete[GraphicConsole.foreground]));
            backpen = new Pen(Color.FromArgb((int)Pallete[GraphicConsole.background]));
